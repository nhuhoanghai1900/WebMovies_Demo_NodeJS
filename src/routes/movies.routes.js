...
route.get("/create", checkToken, checkRole(["admin"]), rateLimit, moviesController.create); // 7.1. Hiển thị form tạo mới movie
route.post("/store", checkToken, checkRole(["admin"]), rateLimit, handleUpload("img"), moviesController.store); // 7.2. Lưu dữ liệu tạo mới vào db
